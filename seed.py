...
from models import Country, State, Base
from sqlalchemy import create_engine
import os

# For seeding, we might need sync engine
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://user:password@localhost/country_db").replace("asyncpg", "psycopg2")
